    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if(menu == 1) {
                ...
                keuangandesa instansi2 = new keuangandesa("Desa Petung", 50000000, 30000000, 70000000, 100000000);
                keuangansekolah instansi3 = new keuangansekolah("SMPN 5", 100000000,50000000,150000000,200000000);
                ...
                instansi3.tampil("Dana belum cair");
                System.out.println("==============================================="); 
